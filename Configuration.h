...
#define STRING_CONFIG_H_AUTHOR "(jcrocholl, KosselRevB)" // Who made the changes. ("Blomker" only edited the parametric values in the sketch. Author name is maintain as jcrocholl to indicate source of this sketch, and credit to where it is due)
...
// #define CUSTOM_MENDEL_NAME "This Denis"
...
#define DELTA_SMOOTH_ROD_OFFSET 189 // mm //158
